    ...
    return (
        <>
            <div className="p-8 mt-10 space-y-6 text-center justify-center items-center flex-grow align-middle">
                ...
                >
                    <h1 className="text-5xl md:text-7xl font-extrabold font-[Alata] tracking-tight leading-tight text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-pink-700 dark:from-pink-300 dark:to-pink-600">
                        Urvi
                    </h1>
                    <h1 className="text-5xl md:text-7xl font-extrabold font-[Alata] tracking-tight leading-tight text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-pink-700 dark:from-pink-300 dark:to-pink-600">
                        Gupta
