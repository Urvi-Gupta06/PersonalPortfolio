  ...
  return (
    <section id="contact" className="py-16 px-6">
      <div className="flex flex-col items-center justify-center gap-10 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-extrabold font-[Alata] text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-pink-700 dark:from-pink-300 dark:to-pink-600">
            Let's
          </h1>
          <h1 className="text-5xl md:text-6xl font-extrabold font-[Alata] text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-pink-700 dark:from-pink-300 dark:to-pink-600">
           Connect
